...
DROP TABLE AUDITORIA_DIMENSOES CASCADE CONSTRAINTS;

DROP TABLE DIMPEDIDO CASCADE CONSTRAINTS;
...
CREATE TABLE FATOVENDAS (
       ...
       CONSTRAINT FK_PEDIDO FOREIGN KEY (COD_PEDIDO) REFERENCES DIMPEDIDO(COD_PEDIDO),
       CONSTRAINT FK_PRODUTO FOREIGN KEY (COD_PRODUTO) REFERENCES DIMPRODUTO(COD_PRODUTO),
       CONSTRAINT FK_CLIENTE FOREIGN KEY (COD_CLIENTE) REFERENCES DIMCLIENTE(COD_CLIENTE),
       CONSTRAINT FK_VENDEDOR FOREIGN KEY (COD_VENDEDOR) REFERENCES DIMVENDEDOR(COD_VENDEDOR),
       CONSTRAINT FK_TEMPO FOREIGN KEY (DATA_VENDA) REFERENCES DIMTEMPO(DATA_VENDA)
);
